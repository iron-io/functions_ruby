...
module IronFunctions
  class AppsApi
    ...
    def apps_app_delete_with_http_info(app, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'app' when calling AppsApi.apps_app_delete" if app.nil?
      # resource path
    ...
    def apps_app_patch_with_http_info(app, body, opts = {})
      ...
      # verify the required parameter 'app' is set
      fail ArgumentError, "Missing the required parameter 'app' when calling AppsApi.apps_app_patch" if app.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling AppsApi.apps_app_patch" if body.nil?
      # resource path
      local_var_path = "/apps/{app}".sub('{format}','json').sub('{' + 'app' + '}', app.to_s)
