...
module IronFunctions
  class RoutesApi
    ...
    def apps_app_routes_route_patch_with_http_info(app, route, body, opts = {})
      ...
      # verify the required parameter 'app' is set
      fail ArgumentError, "Missing the required parameter 'app' when calling RoutesApi.apps_app_routes_route_patch" if app.nil?
      # verify the required parameter 'route' is set
      fail ArgumentError, "Missing the required parameter 'route' when calling RoutesApi.apps_app_routes_route_patch" if route.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling RoutesApi.apps_app_routes_route_patch" if body.nil?
      # resource path
      local_var_path = "/apps/{app}/routes/{route}".sub('{format}','json').sub('{' + 'app' + '}', app.to_s).sub('{' + 'route' + '}', route.to_s)
