...
module IronFunctions
  ...
  class Route
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'jwt_key')
        self.jwt_key = attributes[:'jwt_key']
      end
    ...
    def hash
      [path, image, headers, memory, type, format, max_concurrency, config, timeout, idle_timeout, jwt_key].hash
    end
